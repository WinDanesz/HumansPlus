...
{
    private static final ResourceLocation DEFAULT_TEXTURE = new ResourceLocation("humansplus", "textures/entity/human.png");
    ...
    protected ResourceLocation getEntityTexture(Human entity) {
        if (entity.texture != null && !entity.texture.isEmpty()) {
            return new ResourceLocation("humansplus", "textures/entity/" + entity.texture);
        }
